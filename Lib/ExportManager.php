 ...
 */
namespace FacturaScripts\Core\Lib\ExportManager;
    ...
    public function __construct()
    {
        if (self::$options === null) {
            self::$options = [
                ...
                'JasperCSV' => ['description' => 'jasper-csv-print', 'icon' => 'fa-print'],
                'JasperDOCX' => ['description' => 'jasper-docx-print', 'icon' => 'fa-print'],
                'JasperJRPRINT' => ['description' => 'jasper-jrprint-print', 'icon' => 'fa-print'],
                'JasperODS' => ['description' => 'jasper-ods-print', 'icon' => 'fa-print'],
                'JasperODT' => ['description' => 'jasper-odt-print', 'icon' => 'fa-print'],
                'JasperPDF' => ['description' => 'jasper-pdf-print', 'icon' => 'fa-print'],
                'JasperPPTX' => ['description' => 'jasper-pptx-print', 'icon' => 'fa-print'],
                'JasperRTF' => ['description' => 'jasper-rtf-print', 'icon' => 'fa-print'],
                'JasperXLS' => ['description' => 'jasper-xls-print', 'icon' => 'fa-print'],
                'JasperXLSX' => ['description' => 'jasper-xlsx-print', 'icon' => 'fa-print'],
                'JasperXML' => ['description' => 'jasper-xml-print', 'icon' => 'fa-print'],
